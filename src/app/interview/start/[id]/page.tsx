...
export default function Page() {
  ...
  return (
    <div className="flex flex-col h-screen bg-black text-white">
      {/* 🔒 Reload protection (F5, Ctrl+R, browser reload button) */}
        ...
        <div className="flex flex-col w-[380px] bg-zinc-950 border-r border-zinc-800 p-8 items-center justify-between">
          <div className="flex-1 flex flex-col items-center justify-center space-y-8">
            <div className="relative">
              <div className={`w-40 h-40 rounded-full bg-zinc-900 border-2 flex items-center justify-center transition-all duration-300 ${isMicOn ? 'border-white shadow-lg shadow-white/20 scale-105' : 'border-zinc-700'
                }`}>
            ...
            <AnimatePresence initial={false}>
              {messages.map((msg, idx) => {
                ...
                return (
                  ...
                  >
                    <motion.div layout className={`max-w-[75%] rounded-2xl px-6 py-4 shadow-lg ${msg.role === "interviewer"
                        ? "bg-white text-black"
