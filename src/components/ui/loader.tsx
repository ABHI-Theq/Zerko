...
// ✅ Safe easing definitions (Framer Motion v11 compatible)
const easeInOut: Transition["ease"] = [0.42, 0, 0.58, 1]; // same as 'easeInOut'
const linear: Transition["ease"] = [0, 0, 1, 1]; // same as 'linear'
